...
export const products = [
  ...
  { section: 'edu', group: 'exam', slug: 'matrixiq', icon: 'matrixiq', name: '매트릭스 인적성', chip: '인적성·적성', type: 'app', desc: '도형추리·수열·공간지각 등 추론·수리 적성을 매일 한 사이클로 훈련하고, 약점을 진단해 맞춤으로 성장하는 룰베이스 앱. 완전 무료·광고 없음, 한국어·영어.', ios: null, play: null },
  ...
  { section: 'edu', group: 'practical', slug: 'sentence-forge', icon: 'sentence-forge', name: '글벼림', chip: '글쓰기·문장력', type: 'app', desc: '근대문학 명문장 88편을 문장 단위로 뜯어보고, 400개 넘는 연습으로 내 문장을 직접 다듬는 글쓰기 훈련 앱. 광고·계정·인터넷 없이, 기록은 내 폰에만.', ios: null, play: null },
  // 일상
