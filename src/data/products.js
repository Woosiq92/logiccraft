...
export const products = [
  ...
  { section: 'daily', slug: 'windeck', icon: 'windeck', name: 'WinDeck', chip: '맥 창 관리', warm: true, lab: true, type: 'mac', desc: '맥 기본 창 정렬의 4분할 한계를 넘는 창 덱. 실제 창을 최대 9분할로 타일링하고, 덱에 없는 창은 오른쪽 스트립에 라이브 미러로 띄워 클릭 한 번에 불러옵니다. macOS 11 이상, 무료.', download: 'https://github.com/Woosiq92/windeck/releases/latest/download/WinDeck.dmg' },
