...
export const products = [
  ...
  // 일상
  { section: 'daily', slug: 'family-roadmap', icon: 'family-roadmap', name: '가족 로드맵', chip: '결혼·임신·육아', warm: true, lab: true, type: 'web', desc: '결혼 준비부터 아이 36개월까지, 아는 날짜만 넣으면 기한이 있는 지원금·신청·휴가·검진을 출처와 함께 순서대로 보여 줘요. 식장 지도·견적 비교표, 아빠자격시험, 임신·육아 읽을거리까지 한곳에. 가입·설치 없이 무료.', web: 'https://family-roadmap-production-5c9c.up.railway.app/' },
  ...
  // 수업방과 한 서버를 쓰지만 다른 제품이다. 저쪽은 한 시간, 이쪽은 며칠이고 코드 체계도 따로다.
  { section: 'daily', icon: 'classtools', lab: true, name: '학급 도구', chip: '반장 선거·사다리·뽑기', warm: true, type: 'web', desc: '수업을 열지 않는 날에도 반에서 쓰는 것들. 반장·부반장 선거를 종이 없이 — 이름 없이 기기당 한 표로 받고 실시간 개표까지. 질문 하나를 링크로 던져 두면 며칠이든 답이 쌓입니다. 발표 순서는 사다리와 번호 뽑기로, 남는 시간에는 반 전체가 함께 하는 그림 맞히기. 가입·설치 없이 무료.', web: 'https://classvote-production-6bee.up.railway.app/tools/' },
  ...
  { section: 'edu', group: 'practical', icon: 'teen-ai', name: '10대가 만든 AI', chip: '청소년 AI 사례', lab: true, type: 'web', desc: '열셋에서 열아홉 사이에 AI로 무언가를 만들어 세상에 내놓은 사람들의 사례집. 한 사람마다 나이·왜 시작했는지·무엇으로 만들었는지·어떻게 알려졌는지를 같은 칸으로 정리하고 출처 링크를 답니다. 모아 놓고 보면 드러나는 네 가지 패턴과, 만든 다음 들고 갈 국내외 대회 목록까지. 가입·설치 없이 무료.', web: 'https://logiccraft.co.kr/teen-ai/' },
