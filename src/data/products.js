...
export const products = [
  ...
  { section: 'edu', group: 'practical', icon: 'teen-ai', name: '10대가 만든 AI', chip: '청소년 AI 사례', lab: true, type: 'web', desc: '열셋에서 열아홉 사이에 AI로 무언가를 만들어 세상에 내놓은 사람들의 사례집. 한 사람마다 나이·왜 시작했는지·무엇으로 만들었는지·어떻게 알려졌는지를 같은 칸으로 정리하고 출처 링크를 답니다. 모아 놓고 보면 드러나는 네 가지 패턴까지. 가입·설치 없이 무료.', web: 'https://logiccraft.co.kr/teen-ai/' },
