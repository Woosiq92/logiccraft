...
export const products = [
  ...
  { section: 'edu', slug: 'prompt-dojo', icon: 'prompt-dojo', name: '프롬프트 도장', chip: 'AI 프롬프트', type: 'web', desc: 'AI가 답하는 방식에 기반해, 좋은 프롬프트의 5가지를 문제로 풀며 익히는 훈련. 기초부터 코딩·글쓰기·영상까지 무료로, 가입·설치 없이.', web: 'https://logiccraft.co.kr/prompt-dojo/' },
  // 일상
