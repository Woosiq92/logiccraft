...
export const products = [
  ...
  // 일상
  { section: 'daily', slug: 'family-roadmap', icon: 'family-roadmap', name: '가족 로드맵', chip: '결혼·임신·육아', warm: true, lab: true, type: 'web', desc: '결혼 준비부터 아이 36개월까지, 아는 날짜만 넣으면 기한이 있는 지원금·신청·휴가·검진을 출처와 함께 순서대로 보여 줘요. 식장 지도·견적 비교표, 아빠자격시험, 임신·육아 읽을거리까지 한곳에. 가입·설치 없이 무료.', web: 'https://logiccraft.co.kr/family-roadmap/' },
